...
public class PlayCollision {
    ...
    public Array<ParticleEffect> checkCollisions(){
        ...
        particles();
        playerBulletsAndEnemies();
        enemyBulletsAndBounds();
        enemyBulletsAndPlayer();
        enemyBulletsAndPlayerBullets();
    ...
    public void playerBulletsAndEnemies(){
    ...
    public void enemyBulletsAndBounds(){
    ...
    public void enemyBulletsAndPlayer(){
    ...
    public void enemyBulletsAndPlayerBullets(){
